...
class AssessmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create assessment" do
    assert_difference('Assessment.count') do
      post assessments_url, params: { assessment: { answer: @assessment.answer, question: @assessment.question } }
    end
  ...
  test "should update assessment" do
    patch assessment_url(@assessment), params: { assessment: { answer: @assessment.answer, question: @assessment.question } }
